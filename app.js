const exams = [
  ...
  {person:'Ana', personKey:'ana', system:'Cardiovascular', exam:'LDL-C', result:'132,7 mg/dL', range:'Acima de metas de vários grupos', purpose:'Estima colesterol em partículas aterogênicas LDL.', reading:'Elevação discreta/moderada; pressão normal, ausência de tabagismo e de doença cardiovascular favorecem o risco global.', action:'Registrar pressão exata e completar histórico familiar precoce.', status:'attention'},
  ...
  {person:'Ana', personKey:'ana', system:'Tireoide', exam:'TSH ultrassensível', result:'4,33 mUI/mL', range:'0,40–4,30 (19–61 anos)', purpose:'Sinal hipofisário que regula a tireoide.', reading:'Elevação mínima; queda de cabelo e ganho de peso são inespecíficos, e o calor se sobrepõe à menopausa.', action:'Repetir TSH/T4L e considerar anti-TPO antes de atribuir sintomas.', status:'attention'},
  ...
  {person:'Ana', personKey:'ana', system:'Hormonal', exam:'Cortisol sérico', result:'16,90 µg/dL', range:'Depende do horário', purpose:'Hormônio do eixo do estresse com forte ritmo diário.', reading:'Resultado isolado sem relevância clínica no contexto atual.', action:'Nenhuma investigação adicional por este número isolado.', status:'context'},
  ...
  {person:'Vado', personKey:'vado', system:'Cardiovascular', exam:'LDL-C', result:'178,7 mg/dL', range:'Alto', purpose:'Estima colesterol em partículas LDL aterogênicas.', reading:'Elevação importante; pressão normal, ausência de tabagismo e de doença cardiovascular são contrapesos favoráveis.', action:'Confirmar, calcular risco com pressão exata e discutir após revisar a tireoide.', status:'priority'},
  ...
  {person:'Vado', personKey:'vado', system:'Tireoide', exam:'TSH ultrassensível', result:'6,96 mUI/mL', range:'Alto', purpose:'Sinal produzido pela hipófise para pedir que a tireoide fabrique hormônio.', reading:'A hipófise está aumentando o estímulo para manter o T4 normal: padrão subclínico, não tireoide acelerada.', action:'Confirmar em segunda coleta, dosar anti-TPO e decidir individualmente; LDL alto pesa na decisão.', status:'attention'},
